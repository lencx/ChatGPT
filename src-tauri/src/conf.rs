...
pub const COURTNEY_AI_URL: &str = "http://172.30.30.111:8000";
...
impl AppConf {
  pub fn new() -> Self {
    ...
    Self {
      ...
      tray_width: 360.0,
      tray_height: 540.0,
      main_origin: COURTNEY_AI_URL.into(),
      tray_origin: COURTNEY_AI_URL.into(),
      default_origin: COURTNEY_AI_URL.into(),
